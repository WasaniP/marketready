...
function tagTint(index: number): string {
  ...
  return "border-electric/40 bg-electric/10 text-electric";
}
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-[#0F172A] via-[#111827] to-[#030712]">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-hairline bg-[#0F172A] px-5 pb-14 pt-32 sm:px-8 sm:pb-16 sm:pt-40">
          <div
            aria-hidden="true"
          ...
          <div className="relative mx-auto max-w-6xl text-center">
            <span className="chip border-electric/40 text-electric">Resources</span>
        ...
        <section className="border-b border-hairline bg-[#111827] px-5 pt-14 sm:px-8 sm:pt-16">
          <div className="mx-auto max-w-6xl">
            <div
              role="group"
              aria-label="Filter resources by type"
              className="inline-flex flex-wrap items-center gap-1 rounded-xl border border-hairline bg-white/[0.03] p-1"
            >
              {FILTERS.map((f) => {
        ...
        <section className="border-b border-hairline bg-[#111827] px-5 py-14 sm:px-8 sm:py-16">
          <div className="mx-auto max-w-6xl">
            {posts.length === 0 ? (
              /* Honest empty state (Case Studies tab until the founder
                 supplies real material; no fabricated content). */
              <div className="mx-auto max-w-xl rounded-xl border border-hairline bg-[#1E293B]/50 px-6 py-14 text-center shadow-[0_0_24px_rgba(20,184,166,0.12)]">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {posts.map((post, i) => (
                  <a
                    key={post.slug}
                    href={`/blog/${post.slug}`}
                    className="flex flex-col rounded-xl border border-hairline bg-[#1E293B]/50 p-7 shadow-[0_0_24px_rgba(20,184,166,0.12)] transition-all duration-300 hover:-translate-y-0.5 hover:border-zinc-600 hover:shadow-[0_0_36px_rgba(20,184,166,0.2)]"
                  >
