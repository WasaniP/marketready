/**
 * Case study: Consumer Sports Technology (CASE 02 / 04).
...
const DATA = WORK_CASES[1];

export const Route = createFileRoute("/work/consumer-sports")({
  head: () => ({
    meta: [
  ...
  component: ConsumerSportsPage,
});

function ConsumerSportsPage() {
