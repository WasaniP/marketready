...
export function BookingModal({
 ...
 return (
  ...
  >
   ...
   <div
    ref={panelRef}
    className="relative w-full max-w-md rounded-2xl border border-hairline bg-[#2A2320]/50 p-6 backdrop-blur-xl sm:p-8"
   >
    {status === "done" ? (
     /* ------------------------------------------------ success state */
      ...
      <form onSubmit={handleSubmit} noValidate className="mt-6 flex flex-col gap-4">
       ...
       <div>
        <label htmlFor="booking-website" className="field-label">
         Website <span className="text-ember">*</span>
        </label>
        <input
         id="booking-website"
         type="url"
           ...
           <label
            ...
            className={`flex cursor-pointer items-center gap-3 rounded-lg border px-3.5 py-2.5 transition-colors ${
             checked
              ...
              : "border-hairline bg-white/[0.02] hover:border-hairline"
            }`}
           >
            <input
             type="checkbox"
