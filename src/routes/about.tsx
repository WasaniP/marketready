  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-[#0F172A] via-[#111827] to-[#030712]">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-hairline bg-[#0F172A] px-5 pb-14 pt-24 sm:px-8 sm:pb-16 sm:pt-28">
          <div
            aria-hidden="true"
          ...
          <div className="relative mx-auto flex max-w-[820px] flex-col items-start gap-8 sm:flex-row sm:items-start sm:gap-10">
            ...
            <div className="flex shrink-0 flex-col items-start gap-3">
              ...
              <div
                ...
                className="flex h-[132px] w-[132px] items-center justify-center rounded-full border-2 border-electric/60 bg-[#0B1220] shadow-[0_0_30px_rgba(20,184,166,0.25)]"
              >
                <span className="text-[38px] font-extrabold tracking-tight text-electric/70">
                  WP
                </span>
              </div>
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-electric/10 px-3 py-1 text-[13px] font-medium text-electric transition hover:bg-electric/15"
              >
                <LinkedInIcon />
                LinkedIn
              </a>
            ...
            <div className="max-w-[640px]">
              ...
              <p className="mt-1 text-[14px] font-medium text-electric">
                Founder, MarketReady
              </p>
        ...
        <section className="border-b border-hairline bg-[#0F172A] px-5 py-12 sm:px-8">
        ...
        <section className="border-b border-hairline bg-[#111827] px-5 py-16 sm:px-8 sm:py-24">
          <div className="mx-auto grid max-w-[1000px] gap-12 md:grid-cols-2 md:gap-16">
            {/* Left - section intro + condensed thesis */}
            <div>
              <p className="text-[11px] font-bold uppercase tracking-[0.1em] text-electric">
            ...
            <div className="flex flex-col gap-6">
              {PRINCIPLES.map((p) => (
                <div
                  key={p.n}
                  className="relative overflow-hidden rounded-xl border border-hairline bg-[#0F172A]/60 p-6"
                >
                  {/* Huge ghosted background number */}
                  <span
                    aria-hidden="true"
                    className="pointer-events-none absolute -top-7 -right-3 select-none text-[96px] font-extrabold leading-none text-electric/[0.06]"
                  >
                    {p.n}
                  </span>
        ...
        <section className="border-b border-hairline bg-[#0F172A] px-5 py-16 sm:px-8 sm:py-24">
        ...
        <section className="border-b border-hairline bg-[#111827] px-5 py-16 sm:px-8 sm:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <a
              ...
              className="mt-8 inline-flex h-[44px] items-center justify-center rounded-lg bg-electric px-7 text-[14px] font-bold text-[#0F172A] transition hover:brightness-110"
            >
