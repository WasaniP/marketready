  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-[#0F172A] via-[#111827] to-[#030712]">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-hairline bg-[#030712] px-5 py-10 sm:px-8 sm:py-14">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -top-24 left-1/2 h-72 w-[38rem] -translate-x-1/2 rounded-full bg-electric/[0.06] blur-3xl"
          />
        ...
        <section className="relative overflow-hidden border-b border-hairline bg-[#111827] px-5 py-10 sm:px-8 sm:py-14">
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            <p className="mx-auto mt-10 max-w-2xl text-center text-sm leading-relaxed text-zinc-400">
            ...
            <div className="mx-auto mt-12 flex max-w-2xl flex-col items-center justify-center gap-8 sm:flex-row sm:gap-6">
              <div className="flex flex-col items-center">
                <DeltaGauge
                  ...
                  labelColor="#EF4444"
                />
                <p className="mt-2 text-center text-sm font-medium text-rose-200/60">Before</p>
              </div>
              <div
                aria-hidden="true"
                className="flex items-center text-2xl font-extrabold text-electric sm:text-3xl"
              >
                →
              </div>
              <div className="flex flex-col items-center">
                <DeltaGauge
                  score={86}
                  color="#14B8A6"
                  halo="rgba(20,184,166,0.3)"
                  valueText="#5EEAD4"
                  label="Market Ready"
                  labelColor="#14B8A6"
                />
                <p className="mt-2 text-center text-sm font-medium text-teal-200/70">After</p>
              </div>
            </div>
            <p className="mx-auto mt-10 max-w-2xl text-center text-sm leading-relaxed text-zinc-400">
